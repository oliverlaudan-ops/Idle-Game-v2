...
const upgradeDefinitions = [
  ...
  
  {
    ...
    icon: '👆',
    description: 'Klick-Wert: 2 Energie/Klick (Basis: 1, +1 Bonus)',
    type: 'click',
    size: 0,
    maxCount: 1,
    baseCost: {
  ...
  
  {
    ...
    icon: '👆',
    description: 'Klick-Wert: 4 Energie/Klick (Vorheriger: 2, +2 Bonus)',
    type: 'click',
    size: 0,
    maxCount: 1,
    baseCost: {
  ...
  
  {
    ...
    icon: '👆',
    description: 'Klick-Wert: 9 Energie/Klick (Vorheriger: 4, +5 Bonus)',
    type: 'click',
    size: 0,
    maxCount: 1,
    baseCost: {
